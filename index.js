// `window.location.protocol` must exist for `@gradio/client` to work
if (!window) {
...
// `@gradio/client` requires EventSource!
if (!globalThis.EventSource) {
    globalThis.EventSource = EventSource
}


// this EventSource impl is taken *almost* verbatim from the node module `eventsource` - license in LICENSE.md
// the only difference is that we override the parse() function to pass thru URL objects unchanged.
// without this change, you get an error when trying to use `@gradio/client`.
